...
| `07_ADJACENT_WORK.md` | Tailscale, Headscale, NetBird, Tailnet Lock — how this differs |
| `08_RISKS.md` | Kill criteria, risk register, honest pros and cons |
| `09_EVENT_RULES.md` | Event compliance: originality, commit history, AI attribution |
| `10_JUDGING.md` | Every objection a judge will raise, with the answer |
| `11_DAY0_GATES.md` | **Do this first.** The checks that decide whether the project is buildable |
| `12_SOURCE_NOTES.md` | Research log: partner workshop findings reconciled against the docs above |
...
1. **Do Day 0 before anything else.** The gates in `11_DAY0_GATES.md` can kill the project. One of them is whether a physical Ledger device is available.
...
5. **Commit continuously.** See `09_EVENT_RULES.md`. Large single commits can disqualify.

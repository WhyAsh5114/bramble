...
**Extra points reachable:** ERC-8004 agent identity, a directory making the relay findable by other agents, metered rather than flat pricing, HCS audit trail of relay settlements.

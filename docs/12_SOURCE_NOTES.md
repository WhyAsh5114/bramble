...
**Applied:** all of this is now in `04_TECH_STACK.md` (new "Hackathon ENSv2 Sepolia deployment" section) and `11_DAY0_GATES.md` Gate 0.3 (now step one of the gate, before registering anything).
